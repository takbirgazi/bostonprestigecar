        ...
        >
            <div className="container mx-auto max-w-[1200px] px-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex justify-center items-center">
                    <Link className="text-sm hover:shadow-2xl shadow-[#1ecb15] rounded-sm bg-mainColor text-white px-3 py-1.5 font-extrabold font-poppins flex items-center gap-1" href="tel:+18577772125" ><MdCall className="font-bold text-lg" /> +18577772125</Link>
                </div>
